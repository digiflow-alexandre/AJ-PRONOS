    ...
    <section className="intro" aria-label="Notre approche">
      <div className="wrap">
        <Reveal as="h2" className="intro-heading">
          ...
          <span className="intro-emoji" aria-hidden="true">🎯</span>. Verdict sur WhatsApp{" "}
        ...
        <Reveal as="div" className="intro-pills" delay={200}>
          <span className="intro-pill">#Débutants</span>
          <span className="intro-pill">#Réguliers</span>
          <span className="intro-pill">#Multisports</span>
          <span className="intro-pill">#VIP</span>
        </Reveal>
      </div>
    </section>
  );
